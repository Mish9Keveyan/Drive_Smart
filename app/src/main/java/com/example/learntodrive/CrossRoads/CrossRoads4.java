...
public class CrossRoads4 extends AppCompatActivity {
    ...
    private Questions2 Questions14 = new Questions2();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isAnyRadioButtonNotEmpty) {
                    ...
                    Toast.makeText(CrossRoads4.this, "Выберите правильный ответ", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void showMainImage() {
        ...
        String imgUrl = Questions14.getImages14(QuestionNum);
