...
public class CrossRoads1 extends AppCompatActivity {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isAnyRadioButtonNotEmpty) {
                    ...
                    Toast.makeText(CrossRoads1.this, "Выберите правильный ответ", Toast.LENGTH_SHORT).show();
                }
            }
        });
