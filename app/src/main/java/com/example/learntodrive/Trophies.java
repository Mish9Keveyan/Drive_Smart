...
public class Trophies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (level3 >= 2) {
            v31.setBackgroundResource(R.color.bg_color);
            TV3.setTextColor(getResources().getColor(R.color.bg_color));
            TV3.setText("25%");
        }
        if (level3 >= 3) {
            v32.setBackgroundResource(R.color.bg_color);
            TV3.setTextColor(getResources().getColor(R.color.bg_color));
            TV3.setText("50%");
        }
        if (level3 >= 4) {
            v33.setBackgroundResource(R.color.bg_color);
            TV3.setTextColor(getResources().getColor(R.color.bg_color));
            TV3.setText("75%");
        }
        if (level3 >= 5) {
            ...
            v33.setBackgroundResource(R.color.white);
            v34.setBackgroundResource(R.color.white);
            TV3.setText("100%");
