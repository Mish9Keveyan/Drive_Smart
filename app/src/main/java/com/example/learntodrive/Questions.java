...
public class Questions {
    ...
    private String Choice2[][] = {
            ...
            {"Конец дополнительной полосы на подъеме или полосы разгона.","Дорогу, не имеющую сквозного проезда.","Направление движения к объекту в населенном пункте."},
    ...
    private String CoorectAnswers2[] = {
            ...
            "Дорогу, не имеющую сквозного проезда.",
