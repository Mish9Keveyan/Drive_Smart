...
public class Law3 extends AppCompatActivity {
    ...
    private Questions4 Questions13 = new Questions4();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isAnyRadioButtonNotEmpty) {
                    ...
                    Toast.makeText(Law3.this, "Выберите правильный ответ", Toast.LENGTH_SHORT).show();
                }
            }
        });
