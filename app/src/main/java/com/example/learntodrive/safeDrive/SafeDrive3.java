...
public class SafeDrive3 extends AppCompatActivity {
    ...
    private Questions3 Questions13 = new Questions3();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isAnyRadioButtonNotEmpty) {
                    ...
                    Toast.makeText(SafeDrive3.this, "Выберите правильный ответ", Toast.LENGTH_SHORT).show();
                }
            }
        });
