...
public class SafeDrive4 extends AppCompatActivity {
    ...
    private Questions3 Questions14 = new Questions3();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isAnyRadioButtonNotEmpty) {
                    ...
                    Toast.makeText(SafeDrive4.this, "Выберите правильный ответ", Toast.LENGTH_SHORT).show();
                }
            }
        });
