...
public class SafeDrive2 extends AppCompatActivity {
    ...
    private Questions3 Questions12 = new Questions3();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isAnyRadioButtonNotEmpty) {
                    ...
                    Toast.makeText(SafeDrive2.this, "Выберите правильный ответ", Toast.LENGTH_SHORT).show();
                }
            }
        });
