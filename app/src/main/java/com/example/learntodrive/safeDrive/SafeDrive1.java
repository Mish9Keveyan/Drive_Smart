...
import com.example.learntodrive.CrossRoads.CrossRoads1;
import com.example.learntodrive.CrossRoads.Questions2;
import com.example.learntodrive.CrossRoads.Result2;
...
public class SafeDrive1 extends AppCompatActivity {
    ...
    private Questions3 Questions11 = new Questions3();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isAnyRadioButtonNotEmpty) {
                    ...
                    Toast.makeText(SafeDrive1.this, "Выберите правильный ответ", Toast.LENGTH_SHORT).show();
                }
            }
        });
